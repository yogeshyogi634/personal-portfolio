"use client";
import SkillsSwiper from "@/components/appSwiper/appSwiper";
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              I am an experienced full-stack developer at Gaian Solutions,
              specializing in dynamic marketing websites. Proficient in ReactJS,
              NextJS, JavaScript, HTML, CSS, Tailwind CSS, and NodeJS, I ensure
              efficient project delivery as an agile practitioner. Passionate
              about clean code and user experience, I thrive as a collaborative
              team player with interests in badminton and sports.
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
              Driven by the fusion of creativity and logic, I engineer digital
              experiences, seamlessly integrating front-end elegance with
              back-end robustness, crafting the blueprint of tomorrow&apos;s
              innovations.
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="w-fit bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">
                    Associate Member of Technical Staff
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I spearheaded the development of React-based applications,
                    leveraging my advanced skills as a full-stack developer.
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    In the bootcamp, I learned HTML, CSS, JavaScript, React.js,
                    Node.js, and data structures and algorithms.
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2022 - 2023
              ...
              {/* <div className="flex justify-between h-48">
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    As a team member, I contributed to HTML and CSS-driven
                    development, collaborating with colleagues to deliver
